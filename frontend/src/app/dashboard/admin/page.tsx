    ...
    <div className="min-h-screen" style={{ background: "#fafafd" }}>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <p className="text-sm mb-8" style={{ color: "rgba(5,5,8,0.55)" }}>
          Manage examiners, policies, and monitor system performance.
        </p>
        ...
        >
          ...
          <h2 className="text-xl font-bold mb-2" style={{ color: "#050508" }}>Admin Panel</h2>
          <p className="text-sm" style={{ color: "rgba(5,5,8,0.45)" }}>
            Your administration dashboard is under development.
          </p>
        </div>
      </main>
    </div>
